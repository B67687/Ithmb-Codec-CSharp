...
Decoders listed in standard order used across both C# and Rust repos.

| Decoder | Encoding | Width | Height | Mean time | Allocations |
|---------|----------|-------|--------|-----------|-------------|
| RGB565 | 16-bit RGB | 720 | 480 | 43.4 µs | 0 B |
| RGB555 | 15-bit RGB | 720 | 480 | 44.1 µs | 0 B |
| UYVY | YUV 4:2:2 | 720 | 480 | 188.4 µs | 0 B |
| YUV422 Interlaced | YUV 4:2:2 (fields) | 720 | 480 | 199.3 µs | 0 B |
| YCbCr 4:2:0 | YUV 4:2:0 | 720 | 480 | 210.0 µs | 0 B |
| CL | Per-pixel chroma YUV | 720 | 480 | 192.1 µs | 0 B |
| CLCL | Nibble-chroma YUV | 720 | 480 | 192.6 µs | 0 B |
| Reordered RGB555 | Z-order Morton 16-bit | 256 | 256 | 400 µs | 0 B |

All decoders produce BGRA 8-bit output. Zero heap allocations.
BenchmarkDotNet v0.14, 3 warmup + 10 measurement iterations.
Reordered RGB555 is square-only (w == h); shown at 256×256.
